...
int main()
{
    ...
    else if (carga_de_datos == 2)
    {
        ...
        else if (longitud <= 0 || longitud > 100)
        {
            printf("El valor de la longitud debe ser Positivo o menor a 100...");
            return 0;
        }
    ...
    if (valor_en_pila)
    {
        printf("La clave '%d' está dentro de la Pila\n", clave);
    }
    else
    {
        printf("La clave '%d' NO existe dentro de la Pila\n", clave);
    }
