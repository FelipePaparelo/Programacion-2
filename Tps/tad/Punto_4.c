...
int compararListas(Lista L1, Lista L2)
{
    ...
    TipoElemento elem_L1 = L1->inicio;
    TipoElemento elem_L2 = L2->inicio;
    ...
    while (elem_L1 != NULL && elem_L2 != NULL)
    {
        ...
        {
            cant_claves_L1++;
            elem_L1 = L1->inicio->siguiente;
        }
        else if (elem_L1->clave < elem_L2->clave)
        {
            cant_claves_L2++;
            elem_L2 = L2->inicio->siguiente;
        }
        else
        { // si las claves son iguales avanzamos en ambas listas
            elem_L1 = L1->inicio->siguiente;
            elem_L2 = L2->inicio->siguiente;
        }
        i++;
